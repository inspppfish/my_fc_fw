...
/* USER CODE BEGIN Header_bmi088process_entry */
/**
* @brief Function implementing the bmi088process thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_debug_output_entry */
/**
* @brief Function implementing the debug_output thread.
* @param argument: Not used
* @retval None
*/
